...
public final class PostgreSqlJdbc42Configuration {
    ...
    PostgreSqlJdbc42Configuration(String host, int port, String database, Optional<String> username, Optional<String> password, boolean tls, Duration connectTimeout, Duration socketTimeout, Pool pool, Map<String, String> driverProperties) {
    ...
    static PostgreSqlJdbc42Configuration defaults(String database) {
        return new PostgreSqlJdbc42Configuration("127.0.0.1", 5432, database, Optional.empty(), Optional.empty(), false, Duration.ofSeconds(3), Duration.ofSeconds(30), Pool.defaults(), Map.of());
    }
    ...
    public static final class Builder {
        ...
        private Builder(PostgreSqlJdbc42Configuration source) {
            host = source.host();
            port = source.port();
        ...
        public PostgreSqlJdbc42Configuration build() {
            return new PostgreSqlJdbc42Configuration(host, port, database, username, password, tls, connectTimeout, socketTimeout, pool, driverProperties);
        }
    }

    @Override
    public String toString() {
        return "PostgreSqlJdbc42Configuration[host=" + host + ", port=" + port + ", database=" + database + ", username=" + username + ", password=" + (password.isPresent() ? "[REDACTED]" : "empty") + ", tls=" + tls + ", connectTimeout=" + connectTimeout + ", socketTimeout=" + socketTimeout + ", pool=" + pool + ", driverPropertyKeys=" + driverProperties.keySet() + "]";
    }
    ...
    public boolean equals(Object other) {
        if (this == other)
            return true;
        if (!(other instanceof PostgreSqlJdbc42Configuration that))
            return false;
