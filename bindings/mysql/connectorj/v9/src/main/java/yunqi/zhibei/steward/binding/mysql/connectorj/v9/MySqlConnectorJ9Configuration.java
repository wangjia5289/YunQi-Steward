...
public final class MySqlConnectorJ9Configuration {
    ...
    MySqlConnectorJ9Configuration(String host, int port, String database, Optional<String> username, Optional<String> password, boolean tls, Duration connectTimeout, Duration socketTimeout, Pool pool, Map<String, String> driverProperties) {
    ...
    static MySqlConnectorJ9Configuration defaults(String database) {
        return new MySqlConnectorJ9Configuration("127.0.0.1", 3306, database, Optional.empty(), Optional.empty(), false, Duration.ofSeconds(3), Duration.ofSeconds(30), Pool.defaults(), Map.of());
    }
    ...
    public static final class Builder {
        ...
        private Builder(MySqlConnectorJ9Configuration source) {
            host = source.host();
            port = source.port();
        ...
        public MySqlConnectorJ9Configuration build() {
            return new MySqlConnectorJ9Configuration(host, port, database, username, password, tls, connectTimeout, socketTimeout, pool, driverProperties);
        }
    }

    @Override
    public String toString() {
        return "MySqlConnectorJ9Configuration[host=" + host + ", port=" + port + ", database=" + database + ", username=" + username + ", password=" + (password.isPresent() ? "[REDACTED]" : "empty") + ", tls=" + tls + ", connectTimeout=" + connectTimeout + ", socketTimeout=" + socketTimeout + ", pool=" + pool + ", driverPropertyKeys=" + driverProperties.keySet() + "]";
    }
    ...
    public boolean equals(Object other) {
        if (this == other)
            return true;
        if (!(other instanceof MySqlConnectorJ9Configuration that))
            return false;
