...
/**
 * Configuration for a Jedis 7 pooled client.
 */
public final class Jedis7Configuration {
    ...
    Jedis7Configuration(String host, int port, Optional<String> username, Optional<String> password, int database, boolean tls, Duration connectTimeout, Duration commandTimeout, int minimumIdle, int maximumIdle, int maximumTotal, Duration acquireTimeout) {
    ...
    static Jedis7Configuration defaults() {
    ...
    public String toString() {
        return "Jedis7Configuration[host=" + host + ", port=" + port + ", username=" + username + ", password=" + (password.isPresent() ? "[REDACTED]" : "empty") + ", database=" + database + ", tls=" + tls + ", connectTimeout=" + connectTimeout + ", commandTimeout=" + commandTimeout + ", minimumIdle=" + minimumIdle + ", maximumIdle=" + maximumIdle + ", maximumTotal=" + maximumTotal + ", acquireTimeout=" + acquireTimeout + ']';
    }
    ...
    public static final class Builder {
        ...
        private Builder(Jedis7Configuration source) {
            host = source.host();
            port = source.port();
        ...
        public Jedis7Configuration build() {
            return new Jedis7Configuration(host, port, username, password, database, tls, connectTimeout, commandTimeout, minimumIdle, maximumIdle, maximumTotal, acquireTimeout);
        }
    }
    ...
    public boolean equals(Object other) {
        if (this == other)
            return true;
        if (!(other instanceof Jedis7Configuration that))
            return false;
