...
public final class MariaDb3Configuration {
    ...
    MariaDb3Configuration(String host, int port, String database, Optional<String> username, Optional<String> password, boolean tls, Duration connectTimeout, Duration socketTimeout, Pool pool, Map<String, String> driverProperties) {
    ...
    static MariaDb3Configuration defaults(String database) {
        return new MariaDb3Configuration("127.0.0.1", 3306, database, Optional.empty(), Optional.empty(), false, Duration.ofSeconds(3), Duration.ofSeconds(30), Pool.defaults(), Map.of());
    }
    ...
    public static final class Builder {
        ...
        private Builder(MariaDb3Configuration source) {
            host = source.host();
            port = source.port();
        ...
        public MariaDb3Configuration build() {
            return new MariaDb3Configuration(host, port, database, username, password, tls, connectTimeout, socketTimeout, pool, driverProperties);
        }
    }

    @Override
    public String toString() {
        return "MariaDb3Configuration[host=" + host + ", port=" + port + ", database=" + database + ", username=" + username + ", password=" + (password.isPresent() ? "[REDACTED]" : "empty") + ", tls=" + tls + ", connectTimeout=" + connectTimeout + ", socketTimeout=" + socketTimeout + ", pool=" + pool + ", driverPropertyKeys=" + driverProperties.keySet() + "]";
    }
    ...
    public boolean equals(Object other) {
        if (this == other)
            return true;
        if (!(other instanceof MariaDb3Configuration that))
            return false;
