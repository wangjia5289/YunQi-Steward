...
public interface ConfigurationSource<C> {
    ...
    /**
     * Returns a secret-free operational status snapshot.
     *
     * <p>Implementations which track provider failures should override this method. The default
     * view preserves compatibility for application-defined sources and exposes no failure detail.
     */
    default ConfigurationSourceStatus status() {
        try {
